...
{
    static NSString *cell_id = @"ChooseContactViewControllerCell";
    UITableViewCell *cell = nil;//[tableView dequeueReusableCellWithIdentifier:cell_id forIndexPath:indexPath];
    if (!cell) {
